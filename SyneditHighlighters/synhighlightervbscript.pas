...
begin
  for I := #0 to #255 do
    case I of
      #39: fProcTable[I] :=  {$IFDEF FPC}@{$ENDIF}  ApostropheProc;
      #13: fProcTable[I] :=  {$IFDEF FPC}@{$ENDIF}  CRProc;
      '#': fProcTable[I] :=  {$IFDEF FPC}@{$ENDIF}  DateProc;
...
{$IFDEF SYN_LAZARUS}
procedure TSynVBScriptSyn.GetTokenEx(out TokenStart: PChar; out TokenLength: integer);
begin
...
procedure TSynVBScriptSyn.SetLine(const NewValue: String; LineNumber:Integer);
begin
