...
procedure TSynFoxproSyn.SetLine(const NewValue: String; LineNumber: Integer);
begin
...
{$IFDEF SYN_LAZARUS}
procedure TSynFoxproSyn.GetTokenEx(out TokenStart :PChar; out TokenLength :integer);
begin
