...
procedure TSynGWScriptSyn.SetLine(const NewValue: String; LineNumber:Integer);
begin
...
{$IFDEF SYN_LAZARUS}
procedure TSynGWScriptSyn.GetTokenEx(out TokenStart :PChar; out TokenLength :integer);
begin
