...
procedure TSynBaanSyn.SetLine(const NewValue: String; LineNumber: Integer);
begin
...
{$IFDEF SYN_LAZARUS}
procedure TSynBaanSyn.GetTokenEx(out TokenStart :PChar; out TokenLength :integer);
begin
